<template>
  <div class="container-fluid">
      ...
      <div class="col-lg-4 col-md-5">
        <div class="controls-panel">
          ...
          <div class="mb-4">
            ...
            <p class="text-muted mb-0">Interactive map using pre-loaded JSON county data</p>
          </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col">
        <h3>Vajab JSON faili</h3>
        <textarea v-model="jsonImport" rows="4" cols="45"/>
      </div>
    </div>
  </div>
</template>
...
import geoJsonData from './geo-Json-Data.json'

export default {
  name: 'MapJsonCountyView',
  components: {
    LMap,
    LTileLayer,
    LGeoJson,
  ...
  data() {
    return {
      ...
      jsonImport: '// komponendi sisene import\n' +
          'import geoJsonData from \'./geo-Json-Data.json\'\n'
    }
  },
