    ...
    public List<LocationInfo> findAtmLocations(Integer cityId) {
        ...
        for (LocationInfo locationInfo : locationInfos) {
            ...
            for (TransactionTypeDto transactionTypeDto : transactionTypeDtos) {
                boolean locationTransactionTypeExists = locationTransactionTypeRepository.locationTransactionTypeExists(locationInfo.getLocationId(), transactionTypeDto.getTransactionTypeId());
                transactionTypeDto.setAvailable(locationTransactionTypeExists);
